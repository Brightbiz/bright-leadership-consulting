...
const sections = [
  ...
  },
  {
    heading: "Cookies",
    body: [
      "This site uses only cookies and local storage necessary for the site to function and to record anonymous, aggregated interaction with programme links. No advertising or cross-site tracking cookies are set.",
    ],
  },
];
