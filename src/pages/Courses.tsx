import { Zap, TrendingUp, Users, Lightbulb, Briefcase, ArrowRight, Star, Target, Sparkles, Crown, GraduationCap, Package, FileText, Download, Clock, Award, BookOpen } from "lucide-react";
...
const Courses = () => {
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Course Overview Download Section */}
