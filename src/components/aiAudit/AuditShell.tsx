  ...
  <div className="min-h-dvh bg-navy text-navy-foreground">
    ...
    <div className="mx-auto w-full max-w-[760px] px-5 pb-16">
      <div className="flex flex-wrap items-center gap-x-5 gap-y-2 border-t border-navy-foreground/15 pt-6">
        <Link
          to="/privacy"
          className="rounded-sm text-xs text-navy-foreground/60 underline underline-offset-4 transition-colors hover:text-navy-foreground focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gold"
        >
          Privacy Notice
        </Link>
        <button
